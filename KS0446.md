...
|         |                                                                                  |         |                                                                                                                                                                                                  |
|---------|----------------------------------------------------------------------------------|---------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1       | Keyestudio nano ch340                                                            | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 2       | AM/mini5P transparent blue OD:5.0 L=30cm USB cable                               | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 3       | keyestudio NANO shield                                                           | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 4       | Keyestudio HM-10 Bluetooth-4.0 V3 compatible with HC-06 pins                     | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 5       | HC-SR04 Ultrasonic sensor                                                        | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 6       | 18650 2-cell Battery case with JST-PH2.0MM-2P lead(115MM)                        | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 7       | M1.6\*10MM round-head screw                                                      | 4       | ![](media/e365ac88bcf4cd4780ef895255bb0cd1.png)                                                                                                                                                  |
| 8       | M1.6 304 stainless steel nut                                                     | 4       | ![](media/b9d007f4e9685649685927caa98da8e4.png)                                                                                                                                                  |
| 9       | M3\*6MM round-head screw                                                         | 16      | ![](media/d51ae29baa8bfe389655d79ce9a6df96.png)                                                                                                                                                  |
...
| 16      | M3 304 self-locking nut                                                          | 2       | ![](media/0e8eee1d1b5394061f34f631cefe0493.png)![](media/0e8eee1d1b5394061f34f631cefe0493.png)                                                                                                   |
...
| 19      | Acrylic plate 3PCS  215\*120MM T=3MM  transparent green environmental protection | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)![](media/4562e153c4b9734293a5ad39a998f866.jpeg) ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                |
| 20      | Servo MG90S（14g）23\*12.2\*29mm(black) 180°                                     | 4       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)![](media/4562e153c4b9734293a5ad39a998f866.jpeg)![](media/4562e153c4b9734293a5ad39a998f866.jpeg)![](media/4562e153c4b9734293a5ad39a998f866.jpeg) |
| 21      | Female to female 10CM Jumper wire                                                | 20      | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 22      | yellow and black Handle 3\*40MM cross screwdriver                                | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 23      | Transparent red film acrylic double-sided adhesive tape                          | 1       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
| 24      | Flange bearing                                                                   | 2       | ![](media/4562e153c4b9734293a5ad39a998f866.jpeg)                                                                                                                                                 |
...
Navigate the website <https://www.arduino.cc/>
...
You could click ![](media/8bbd995a157f54ca4ec26690d61c62fb.png)to download an
installer of Arduino 1.8.13 version, which needs to be installed manually.

When you tap![](media/7c7fbbb64026bf7b07278923d0f8134c.png)，a zip file of
Arduino 1.8.13 version will be directly downloaded, and you only need to unzip
it to finish installation.
...
Click the components( Insall Arduino software）you want to install, and click
Next to continue.

![](media/139907b575f66d17faa0bc4485f1210b.png)

Click Browse and select the folder where **Arduino IDE file locates** and click
Install.
...
Let’s install driver after the download is finished. The USB to serial port chip
of this control board is CH340G. So you need to install the driver for the chip.

If your computer is Windows10，connect the board to your computer,
...
If not, you need to install manually, right-click“**USB2.0-Serial**”and tap
“**Update Driver**”-\>“**Search automatically for updataed driver software**”.
...
Click Browse to navigate the driver folder, select“usb_ch341_3.1.2009.06”folder
and“OK”(we put“usb_ch341_3.1.2009.06”folder in the KS0446.....programming folder)

![](media/36899f8b6ac19df6a03cbcd9e286ef4d.png)

Click“Next”，once the software was installed, you will get a confirmation
message. Click“Close”after installation completed.
...
board.(the development board we use is NANO board, therefore, select **Arduino
Nano)**
...
Upload the program successfully, the on-board LED lights on for 1s, goes off for
1s. Congratulation, you finish the first program.
...
For example, the built-in LiquidCrystal library makes it easy to talk to
character LCD displays. There are hundreds of additional libraries available on
...
**Step 1:** After download well the Arduino IDE, you can right-click the icon of
Arduino IDE.
...
**Step 3：**Next to find out the“libraries”folder of frog robot(seen in the
link: https://fs.keyestudio.com/KS0446)
...
You can click the link to check out how to test the keyestudio Nano CH340:

<https://wiki.keyestudio.com/Ks0173_keyestudio_Nano_ch340>
...
![](media/2abbd19b346dc42c503de16fe1120938.jpeg)For external power, the NANO
shield comes with a PH2.0-2P connector (input DC7-12V); a Power_Switch for power control.
...
![](media/bffe59e8151db9645768d3a29a9b06a6.png)
...
![](media/976f21653a20b3ef9e3c21fece0b38f9.jpeg)Included with your servo motor
...
![](media/d9e77265b337faa850610d7404d371d3.png)
...
for (int i = 0; i \<= 180; i = i + (1)) { //the variable i is used to save the
location of the servo, from 0° to 180°，the step length is 1

servo_4.write(i); //make the servo to rotate the location of variable i

delay(200); //wait for 200ms to make the servo to rotate the location of
variable i }

for (int i = 180; i \>= 0; i = i + (-1)) { //the variable i is used to save the
location of the servo, from 0° to 180°, the step length is 1
...
2.  write（angle）——The statement used to set the rotation angle of the servo.
    The range of the angle that can be set is 0° to 180°.

3.  read（）——The statement used to read the angle of the steering gear can be
    understood as reading the value in the last write()
    command.attached（）——Determine whether the servo parameters have been sent
    to the interface where the servo is located.

1.  Note: the above statement writing format is servo variables names like
    myservo.attach(4)
...
for (int i = 0; i \<= 180; i = i + (20)) { //the variable i is used to save the
location of the servo, from 0° to 180°, the step length is 20
...
for (int i = 180; i \>= 0; i = i + (-20)) { //the variable i is used to save the
location of the servo, from 0° to 180°, the step length is 20
...
![](media/0d00b92063db6dbc3af2efdd6b2f90f3.jpeg)
...
![](media/1a1cb3eb0a8f65065cbacc85d9e74e1d.png)
...
float distance = pulseIn(7, HIGH) / 58.00; // Read the high pulse on pin 7,
divide the maximum pulse time by 58.00, and assign the result to the distance
variable as a floating value delay(10); // delay in 10ms
...
Serial.begin(9600); //open the serial port, set the data transmission speed to
9600bps

pinMode(6, OUTPUT); //Initialize digital pin 6 to output mode, connect to Trig
of ultrasonic sensor

pinMode(7, INPUT); //set the digital 7 to output, and connect the Eco of the
ultrasonic sensor
...
Open the **Monitor** ![](media/affd123b80bcd2cbfc8ffeba35dc1a3c.png) and
...
**Code explanation**float distance = pulseIn(7, HIGH) / 58.00

The pulseIn function is actually a simple function to measure the pulse width,
and the default unit is us. That is to say, what pulseIn measures is the time
elapsed from transmitting to receiving ultrasonic waves. The divisor of 58 is
also well understood, and the speed of sound in dry, 20°C air is about 343 m/s,
or 34,300 cm/s. Or, let's do a unit conversion, divide 34,300 by 1,000,000
cm/microsecond. That is: 0.0343 cm/microsecond, and another angle, 1/(0.0343
cm/microsecond) is: 29.15 microseconds/cm. This means that every 291.5
microseconds represents a distance of 10CM. 1 cm is 29.15 microseconds. But
after sending to receiving the echo, the sound travels twice the distance.

So the actual distance is 1 cm, which corresponds to 58.3 microseconds. In fact,
the entire ranging process is the time from when the sound wave is sent to the
time when the echo is received. The first distance in your program is actually
the time us. So to change the distance in cm, divide it by 58. Of course
dividing by 58.3 may be more accurate. So we can get the measured distance with
pulseIn(7, HIGH) / 58.00.
...
float distance = pulseIn(7, HIGH) / 58.00; // Read the high-level pulse on pin
7, divide the maximum pulse time by 58.00, and assign the result to the distance
variable as a floating value delay(10); // delay in 10ms
...
Serial.print(checkdistance()); //Output checkdistance() value through serial
port without wrapping()
...
1.  Change the baud rate and delay time to see the result.
...
![](media/ec30591f93f8e594e2e1bb9e4f4c202f.png)
...
![](media/761f854a4683c8f36cbd6a1b02d577d8.png)
...
![](media/d8b18d2dca2e224473a82a94269aecf1.png)
...
![](media/c38c6110815744b452d5a9e56ebc5550.jpeg)
...
void oscillate(int A[N_SERVOS], int O[N_SERVOS], int T, double
phase_diff[N_SERVOS]){
...
for(int i=0;i\<N_SERVOS;i++) increment[i] =
...
for (int i = 0; i \<= 2; i = i + (1)) { //set the variable i to save times of
rubbing, from 0 to 2, step is 1
...
for (int i = 0; i \<= 2; i = i + (1)) { //set the variable i to save times of
swinging, from 0 to 2, step is 1
...
![](media/23e34439fe40b36be5b61f15af7eab50.png)
...
volatile int distance; //Integer variable used to store the distance value
...
distance = checkdistance(); //Assign the value of checkdistance() to the
variable distance
...
} else if (distance \> 10 && distance \<= 20) { //or else distance \> 10 and
distance \<= 20
...
![](media/2e67efb180b00e25c30f64a7bd486f13.jpeg)
...
2.  Then tap the option CONNECT on the APP, searching the Bluetooth.
...
char bluetooth_val; //Character variable, used to store the value received by
Bluetooth
...
if (Serial.available()) //Determine whether there is data in the serial port
buffer
...
![](media/a2820073393e882b50c3f2656b541e69.png)
...
switch (bluetooth_val) { //The value of the variable bluetooth_val is compared
...
![](media/0c4e50a10bf3018b01799fd044049b86.jpeg)
...
for (int i = 0; i \<= 2; i = i + (1)) { //set the variable i to save times of
friction, from 0 to 2, the step is 1
